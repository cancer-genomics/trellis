...
reads from bam files. The main use-cases are (1) to identify rearranged read
pairs that support structural variants, (2) assess BLAT realignment of selected
reads for consistency with putative rearrangements and the whole-genome aligner.
Most use-cases require a BAM file. For the puporse of illustrating examples in
this vignette, we use BAM files in the `svbams` package.
...
For visualization, te combine the read pairs in a single object.
