...
#' as a metadata column named \code{std_cnt} for GC normalization by \code{svpreprocess::binGCCorrect()}.
#' @examples
#' library(Rsamtools)
#' library(svbams)
#' library(svfilters.hg19)
...
#' named \code{std_cnt} that is generally generated by \code{svpreprocess::binNormalize()}. 
#' @details 
